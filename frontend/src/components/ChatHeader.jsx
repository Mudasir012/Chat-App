import { X, MoreVertical, Phone, Video, Hash, Users } from "lucide-react";
      ...
      <div className="py-1.5 px-6 border-b border-[var(--border)] bg-[var(--bg)]/50 backdrop-blur-md">
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-4">
            <div className="size-8 rounded-xl bg-[var(--accent)]/20 flex items-center justify-center ring-2 ring-[var(--accent)]/10">
          ...
          <div className="flex items-center gap-2">
            ...
            <button
              ...
              className="p-2 text-[var(--text-muted)] hover:bg-red-50 hover:text-red-600 rounded-xl transition-all"
            >
              <X className="size-5" />
            </button>
          </div>
